...
@implementation SendReportRequest
...
{
    NSString *urlString = [[NSString alloc] initWithFormat:@"/reports/?x=%f&y=%f", longitude, lattitude];
    NSString *signedString = [BaseRequest urlSignedWithString:urlString];
    
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:signedString]
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:
     ^(NSURLResponse *response, NSData *data, NSError *error)
     {
         ...
         NSNotification *notif = [NSNotification
                                  notificationWithName:@"NetworkManagerDidSendReportNotification"
                                  object:self
                                  userInfo:dict];
